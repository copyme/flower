...
// ///////////////////////////////////////////////////////////////////////////
inline std::string intToString(int in) {
...
template<typename T> inline T min(const T& a, const T& b, const T& c, const T& d, const T& e) {
...
template<typename T> inline T max(const T& a, const T& b, const T& c, const T& d, const T& e) {
    return max(max(max(a,b),max(c,d)),e);
}

template<typename T> inline T clamp(const T& x, const T& lower = T(zero), const T& upper = T(one)) {
